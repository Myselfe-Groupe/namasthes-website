        ...
        <main className="bg-background text-foreground">
            <div className="mx-auto w-full max-w-6xl px-6 py-20 sm:px-10 lg:px-12">
                <div className="relative flex flex-col gap-4 justify-center items-center">
                    <h1 className="absolute top-18 text-4xl font-text uppercase text-secondary z-10">Boulangerie</h1>
                    <span className="font-title text-accent/70 text-9xl text-center drop-shadow-lg z-0">Boulangerie</span>
