...
export default async function SalonDeThePage({ searchParams }: { searchParams: Promise<{ page?: string }> }) {
    ...
    return (
        <main className="bg-background text-foreground">
            ...
            <ProductsSection category="salon-de-the" page={Number.isNaN(page) ? 1 : page} />
        </main>
    );
}
