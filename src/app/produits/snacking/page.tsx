...
export default async function SnackingPage({ searchParams }: { searchParams: Promise<{ page?: string; q?: string }> }) {
    ...
    return (
        <main className="bg-background text-foreground">
            ...
            <ProductsSection category="snacking" page={Number.isNaN(page) ? 1 : page} query={params.q} />
        </main>
    );
}
